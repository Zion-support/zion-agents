...
After DNS propagates, drop a `CNAME` file containing `agents.ziontechgroup.com` in each repo (or ask to flip custom domains). GitHub will then issue HTTPS certificates for the subdomains.
